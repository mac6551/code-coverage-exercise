...
def test_init_returns_empty_list_if_no_courses():
    name = "Ada Lovelace"
    level = "sophomore"
...
def test_get_student_with_more_classes_when_student_b_has_more():
    charles = Student("Charles Babbage", "senior", ["mechanical engineering"])
    ada = Student(
        "Ada Lovelace",
        "sophomore",
...
def test_get_student_with_more_classes_when_student_a_has_more():
